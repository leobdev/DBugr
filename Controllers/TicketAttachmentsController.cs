...
namespace DBugr.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,FileName,FileData,Created,TicketId,UserId,FileContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,FileName,FileData,Created,TicketId,UserId,FileContentType")] TicketAttachment ticketAttachment)
        {
