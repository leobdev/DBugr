...
namespace DBugr.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public InvitesController(ApplicationDbContext context, UserManager<BTUser> userManager, IDataProtector protector, IBTProjectService projectService, GmailEmailService emailService, IBTInviteService inviteService)
        {
            _context = context;
